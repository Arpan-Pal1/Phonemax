...
<body style="background-color:antiquewhite;">
    ...
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner" >
            <div class="carousel-item active" data-bs-interval="2500">
                <a href="shop.php"><img src="img/carousel1.png" class="d-block w-100" alt="..."></a>
            </div>
            <div class="carousel-item" data-bs-interval="2500">
                <a href="shop.php"><img src="img/carousel2.png" class="d-block w-100" alt="..."></a>
            </div>
            <div class="carousel-item" data-bs-interval="2500">
                <a href="shop.php"><img src="img/carousel3.png" class="d-block w-100" alt="..."></a>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-2">
                <div class="card" >    
                   <a href="brand_shop.php?id=1"><img src="img/Apple-logo.jpg" class="card-img-top" alt="apple"></a>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="card" >    
                   <a href="brand_shop.php?id=2"><img src="img/Nokia-logo.jpg" class="card-img-top" alt="nokia"></a>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="card" >    
                   <a href="brand_shop.php?id=8"><img src="img/OnePlus-logo.jpg" class="card-img-top" alt="Oneplus"></a>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="card" >    
                   <a href="brand_shop.php?id=5"><img src="img/Samsung-logo.jpg" class="card-img-top" alt="Samsung"></a>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="card" >    
                   <a href="brand_shop.php?id=6"><img src="img/Vivo-logo.jpg" class="card-img-top" alt="Vivo"></a>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="card" >    
                   <a href="brand_shop.php?id=9"><img src="img/Xiaomi-logo.jpg" class="card-img-top" alt="Mi"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="banner-text">
            <div class="row">
                ...
                <div class="col-sm-2"><br>
                   <a href="shop.php"><button type="button" id="banner-button" class="btn btn-outline-warning"><b>Shop now</b></button></a>
                </div>
            </div>
        </div>
    </div>
